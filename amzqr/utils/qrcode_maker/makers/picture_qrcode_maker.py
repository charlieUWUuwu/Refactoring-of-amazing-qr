...
class PictureQRCodeMaker(BaseQRCodeMaker):
    ...
    def run(self):
        ...
        try:
            ...
            qr_name = self._combine(new_ver, qr_name, self.params.picture, self.params.colorized, self.params.contrast, self.params.brightness, self.params.save_dir, self.params.save_name)
