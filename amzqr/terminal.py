...
def main():
    ...
    try:
        myConfig = QRCodeConfig(args.Words, args.version, args.level, args.picture, args.colorized, args.contrast, args.brightness, args.name, args.directory)
        maker = QRCodeMakerFactory.get_maker(myConfig)
